...
Route::post('register-app', [AuthController::class, 'register']);
...
Route::get('/sync/categories', [CategoryController::class, 'getUpdates']);
Route::post('/sync/product_units', [CategoryController::class, 'syncProductUnits']);
Route::get('/sync/product_units', [CategoryController::class, 'getUpdateProductUnits']);
Route::post('/sync/cash_categories', [CategoryController::class, 'syncCashCategories']);
