...
class DashboardController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        $users = User::orderBy('id', 'desc')
            ...
            ->get(['id', 'name', 'email', 'roles', 'is_type', 'marketing', 'phone', 'booking_id', 'device_id', 'created_at']);
        ...
        $callback = function () use ($users, $typeLabels) {
            ...
            fputcsv($handle, ['ID', 'Name', 'Email', 'Roles', 'Type', 'Marketing', 'Subscription', 'Login Status', 'Created At']);
