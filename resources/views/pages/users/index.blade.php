                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="{{ route('user.export', array_filter(['name' => request('name'), 'is_type' => request('is_type')], fn($v) => $v !== null && $v !== '')) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="float-right">
                                    <form method="GET" action="{{ route('user.index') }}" class="d-flex align-items-center" style="gap: 8px;">
